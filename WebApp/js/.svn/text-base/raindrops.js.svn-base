...
$.widget("water.raindrops", {
    options: {
        waveLength: 250,    // Wave Length. A numeric value. The higher the number, the smaller the wave length.
    ...
    _create: function () {
        ...
        this.options.realWidth = window.innerWidth * 0.6;
