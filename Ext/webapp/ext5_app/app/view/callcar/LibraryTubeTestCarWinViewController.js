...
Ext.define('Evcorp.view.callcar.LibraryTubeTestCarWinViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.LibraryTubeTestCarWin',
    onSubmitClick:function(){
    	...
    	var arriveDate = form.getForm().getValues().arriveDate;
    	var win = this.getView();
    	var isValid = form.getForm().isValid();
    	if(isValid){
    		win.mask("请稍等，正在处理中...","x-mask-loading");
    		Ext.Ajax.request({
    			url : 'callCar/putInStorageAgree',
    			params : {
    				taskId : taskId,
