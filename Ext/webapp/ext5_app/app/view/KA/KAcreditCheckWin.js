Ext
		.define(
				'Evcorp.view.KA.KAcreditCheckWin',
				{
					extend : 'Ext.window.Window',
					alias : 'widget.KAcreditCheckWin',
					requires : [
							'Evcorp.view.KA.KAcreditCheckWinViewController',
							'Evcorp.view.KA.KAcreditCheckWinViewModel',
					...
					viewModel : {
						type : 'KAcreditCheckWin'
					},
					controller : 'KAcreditCheckWin',
					modal : true,
					closable : true,
					title : '征信审核',
					layout : {
