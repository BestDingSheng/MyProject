...
Ext.define('Evcorp.view.INV.checkoutPanelViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.checkoutPanel',
    oncarCheckoutAdd : function() {
    	var checkinwin = Ext.create({
    		xtype : 'carCheckoutAddWin',
    		width : '90%',
    		closeAction : 'destroy'
    	});
    	checkinwin.show();
	...
	onCreateClaimRule : function() {
		...
		var accModel = new Evcorp.model.checkoutDemand({
					id : -1
				});
