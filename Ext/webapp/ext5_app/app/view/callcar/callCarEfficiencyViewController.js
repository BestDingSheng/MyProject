...
Ext.define('Evcorp.view.callcar.callCarEfficiencyViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.callCarEfficiency',
    onQueryClick:function(){
        ...
        var reportStore = this.getView().getViewModel().getStore('CallCarDemandEfficiencyReportStore');
