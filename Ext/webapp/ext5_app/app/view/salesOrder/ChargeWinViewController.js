...
Ext.define('Evcorp.view.salesOrder.ChargeWinViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.chargeWin',
    initWindow:function(){
    	var win = this.getView();
    	var businessKey = win.businessKey; 
    	var businessType = 'attachBizEntityType_XSDZ'; // 附件业务实体类型：合同材料代码
    	var businessTypeName = '销售电桩材料'; 
