Ext.define('Evcorp.view.contractCar.payDepositWin', {
	extend : 'Ext.window.Window',
	alias : 'widget.payDepositWin',
	requires : [ 
	        'Evcorp.view.contractCar.payDepositWinViewController',
			'Evcorp.view.contractCar.payDepositWinViewModel',
