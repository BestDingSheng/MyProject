...
Ext.define('Evcorp.view.task.CustomerMangerPanelViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.customerManagerPanel',
...
//        var rec = new Evcorp.model.Role({id : -1});
//        
...
//		    	        roleStore.loadPage(1,{"start":0,"limit":20});
//		    	    });   
//		    	}
//		    },roleGrid);
//    	    
...
//    
//        var roleForm = Ext.ComponentQuery.query("viewport rolemangerpanel form")[0];
//     	var role = Ext.create('Evcorp.model.Role',  roleForm.getForm().getValues());
...
//      	}
//    	
//    	var id = {sysRoleId : roleId};
//        sysFunction.findAllFunction(id, function(result){
//        	var root = result;
//            var roleWin = Ext.create('Evcorp.view.role.RoleFuncWin');
...
//    },
        ...
        var roleGrid = Ext.ComponentQuery.query("viewport customerManagerPanel grid")[0];
    ...
    onRestAddClick: function(){
    	var ouType = Ext.create('Evcorp.model.OuType', {ouTypeName: 'Lenlee', entityName: 'Lenlee'});
    	ouType.save({
    		success:function(){
    			alert('添加成功');
    		}
    ...
    onRestDeleteClick: function(){
    	var ouType = Ext.create('Evcorp.model.OuType', {id: 62, ouTypeName: 'Lenlee', entityName: 'Lenlee'});
    	ouType.erase();
    }
});
