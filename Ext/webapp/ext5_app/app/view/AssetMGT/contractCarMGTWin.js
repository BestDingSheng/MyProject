Ext
		.define(
				'Evcorp.view.AssetMGT.contractCarMGTWin',
				{
					extend : 'Ext.window.Window',
					alias : 'widget.contractCarMGTWin',
					requires : [
							'Evcorp.view.AssetMGT.contractCarMGTWinViewController',
					...
					viewModel : {
						type : 'contractCarMGTWin'
					},
					controller : 'contractCarMGTWin',
					modal : true,
					closable : true,
					maximizable: true,
					title : '资产管理',
