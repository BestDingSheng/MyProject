...
window.onload = function(){
	...
	*****************************************************************************/
	...
	for(var i = 0; i < aGoodsMDownImg2.length; i++){
		aGoodsMDownImg2[i].src = 'img/goods_m_down/'+arrGoodsMDownImg[aGoodsMUlLiNum2][i];
	}
	...
	oGoodsMDownPrev.onclick = function(){
		...
		for(var i = 0; i < aGoodsMDownImg3.length; i++){
			aGoodsMDownImg3[i].src = 'img/goods_m_down/'+arrGoodsMDownImg[aGoodsMUlLiNum2][i];
		}
...
/************************************life*****************************************/
	var oLifeimg = document.getElementById('life_img');
	var aLifeLi = getByClass('life_li',oLifeimg)
