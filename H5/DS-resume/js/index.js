$(function() {
	...
	c.load("<div class='bef_comment writecode'>&nbsp;*hi,我的名字叫丁盛，是上海一家互联网创业公司的前端工程师</div>");
	...
	w.load("<p><div class='writecode'>丁盛</div>");
	w.load("<div class='writecode'>前端工程师(今韬新能源技术有限公司)</div>");
	w.load("<div class='writecode'>前端开发工程师</div></p>");
	w.load("<h1 class='writecode'>联系我</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>mail:727040141@qq.com</li>");
	w.load("<li class='writecode'>blog:<a href='http://www.cnblogs.com/-ding/'>http://www.cnblogs.com/-ding/</a></li>");
	w.load("<li class='writecode'>github:<a href='https://github.com/7270401471' target='_blank'>https://github.com/7270401471</a></li>");
	w.load("</ul>");
	w.load("<h1 class='writecode'>技能</h1>");
	w.load("<ul>");
	w.load("<li class='writecode'>掌握JavaScript语言、善用jQuery、Zepto、BootStrap、了解Angular、React等框架，能熟练手写兼容各浏览器的CSS，结构符合W3C标准的HTML。</li>");
	w.load("<li class='writecode'>熟练运用Photoshop、Sublime text、HBuilder、Firebug等常用网页设计制作软件</li>");
	w.load("<li class='writecode'>熟练各种Web前端开发技术H5,CSS3,jQuery,React,Angular</li>");
	w.load("<li class='writecode'>熟悉html5+css3, 有手机网页制作经验，能够熟练制作移动端、响应式网站</li>");
	w.load("<li class='writecode'>熟练使用Firefox,Chrome等浏览器的Debug工具并快速解决页面中出现的bug；</li>");
	...
	c.load("<div class='comment writecode'>&nbsp;*QQ/微信:727040141</div>");
	c.load("<div class='comment writecode'>&nbsp;*mobile:13122022388</div>");
