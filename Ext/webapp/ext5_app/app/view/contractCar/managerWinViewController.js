...
Ext.define('Evcorp.view.contractCar.managerWinViewController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.managerWin',
    initWindow:function(){
    ...
    onAgreeClick:function(){
    	...
    	Ext.Ajax.request({
			url : 'ccOrder/storeManagerApproveAgree',
			params : {
				taskId : taskId,
    ...
    onRejectClick:function(){
    	...
    	if(comment==null||comment==''){
    		...
    		win.mask("请稍等，正在处理中...","x-mask-loading");
    		Ext.Ajax.request({
    			url : 'ccOrder/storeManagerApproveReject',
    			params : {
    				taskId : taskId,
    				processInstanceId : processInstanceId,
    				businessKey : businessKey,
